...
export default {
  ...
  setup(props) {
    ...
    const loadKakaoMapScript = () => {
      ...
      if (!KAKAO_MAP_KEY) {
        return Promise.reject(new Error('Kakao map key is missing. Set VITE_KAKAO_MAP_KEY in your .env'))
      }
      ...
      kakaoMapScriptPromise = new Promise((resolve, reject) => {
        ...
        console.log('KAKAO_URL', `https://dapi.kakao.com/v2/maps/sdk.js?appkey=${KAKAO_MAP_KEY}&autoload=false`)
